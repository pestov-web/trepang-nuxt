...
<template>
  <section class="px-5 pt-3 pb-5 flex flex-col gap-4 w-full">
    <h1 class="text-2xl">Политика обработки персональных данных</h1>
    <UDivider />
    <h4 class="text-xl font-bold">1. Общие положения</h4>
    ...
    <p>
      ...
      обеспечению безопасности персональных данных&nbsp;Доктор Панг(далее –
      Оператор).
    </p>
    <ol class="list-decimal pl-8 flex flex-col gap-2">
      ...
      <li>
        ...
        может получить о посетителях веб-сайта&nbsp;http://trepang.online/.
      </li>
    </ol>
    ...
    <ol class="list-decimal pl-8 flex flex-col gap-2">
      ...
      <li>
        ...
        интернет по сетевому адресу&nbsp;http://trepang.online/;
      </li>
      <li>
      ...
      <li>
        Пользователь – любой посетитель веб-сайта&nbsp;http://trepang.online/;
      </li>
      <li>
    ...
    <h5 class="text-xl font-bold">4. Цели обработки персональных данных</h5>
    <ol class="list-decimal pl-8 flex flex-col gap-2">
      <li>
      ...
      <li>
        ...
        почты&nbsp;info@trepang.online&nbsp;с пометкой «Отказ от уведомлениях о
    ...
    <ol class="list-decimal pl-8 flex flex-col gap-2">
      <li>
        ...
        специальные формы, расположенные на сайте&nbsp;http://trepang.online/.
    ...
    <ol class="list-decimal pl-8 flex flex-col gap-2">
      ...
      <li>
        ...
        электронный адрес Оператора&nbsp;info@trepang.online&nbsp;с пометкой
    ...
    <h5 class="text-xl font-bold">8. Заключительные положения</h5>
    <ol class="list-decimal pl-8 flex flex-col gap-2">
      <li>
        ...
        помощью электронной почты&nbsp;info@trepang.online.
      </li>
      <li>
